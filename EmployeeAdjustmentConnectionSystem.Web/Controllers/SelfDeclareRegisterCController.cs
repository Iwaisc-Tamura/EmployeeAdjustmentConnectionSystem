...
namespace EmployeeAdjustmentConnectionSystem.Web.Controllers {
    ...
    /// 目標管理入力コントローラー
    /// </summary>
    public class SelfDeclareRegisterCController : Controller {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        public ActionResult Index(int? id, string tableType) {
            try {
                ...
                //ビジネスロジックから取得
                //return View((new SelfDeclareRegisterCBL(tableType)).Select(id));
                var bl = new SelfDeclareRegisterCBL();
        ...
        public ActionResult Sign(SelfDeclareRegisterCViewModels model, string value) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        public ActionResult SignCancel(SelfDeclareRegisterCViewModels model, string value) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        public ActionResult Save(SelfDeclareRegisterCViewModels model) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        public ActionResult PrevDataCopy(SelfDeclareRegisterCViewModels model) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        //public ActionResult Save2Print(SelfDeclareRegisterCViewModels model) {
        //    try {
        //        //開始
        //        nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        public ActionResult Back(SelfDeclareRegisterCViewModels model, string value) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
                //検索画面へ
