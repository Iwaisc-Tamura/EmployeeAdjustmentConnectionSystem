...
namespace EmployeeAdjustmentConnectionSystem.Web.Controllers {
    ...
    /// 目標管理入力コントローラー
    /// </summary>
    public class SelfDeclareRegisterAController : Controller {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        public ActionResult Index(int? id, string tableType) {
            try {
                ...
                //ビジネスロジックから取得
                //return View((new SelfDeclareRegisterABL(tableType)).Select(id));
                var bl = new SelfDeclareRegisterABL();
        ...
        public ActionResult Sign(SelfDeclareRegisterAViewModels model, string value) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
                ...
                //ビジネスロジックから
                SelfDeclareRegisterABL bl = new SelfDeclareRegisterABL();
        ...
        public ActionResult SignCancel(SelfDeclareRegisterAViewModels model, string value) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        public ActionResult Save(SelfDeclareRegisterAViewModels model) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        public ActionResult PrevDataCopy(SelfDeclareRegisterAViewModels model) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        //public ActionResult Save2Print(SelfDeclareRegisterAViewModels model) {
        //    try {
        //        //開始
        //        nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        public ActionResult Back(SelfDeclareRegisterAViewModels model, string value) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
                //検索画面へ
