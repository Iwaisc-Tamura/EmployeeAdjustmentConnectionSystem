...
namespace EmployeeAdjustmentConnectionSystem.Web.Controllers {
    ...
    /// 目標管理入力コントローラー
    /// </summary>
    public class SelfDeclareRegisterA11Controller : Controller {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        public ActionResult Index(int? id, string tableType) {
            try {
                ...
                //ビジネスロジックから取得
                //return View((new SelfDeclareRegisterA11BL(tableType)).Select(id));
                var bl = new SelfDeclareRegisterA11BL();
        ...
        public ActionResult Sign(SelfDeclareRegisterAtoCViewModels model, string value) {
            try {
                ...
                //ビジネスロジックから
                SelfDeclareRegisterA11BL bl = new SelfDeclareRegisterA11BL();
                ...
                ModelState.Clear();
                //再表示
                bl = new SelfDeclareRegisterA11BL();
                model = bl.Select(mNo);
                bl.SetMode(model, lu);
