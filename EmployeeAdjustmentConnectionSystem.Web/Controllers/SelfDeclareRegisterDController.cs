...
namespace EmployeeAdjustmentConnectionSystem.Web.Controllers {
    ...
    /// 目標管理入力コントローラー
    /// </summary>
    public class SelfDeclareRegisterDController : Controller {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        public ActionResult Index(int? id) {
            try {
                ...
                //ビジネスロジックから取得
                //return View((new SelfDeclareRegisterDBL(tableType)).Select(id));
                var bl = new SelfDeclareRegisterDBL();
        ...
        public ActionResult Sign(SelfDeclareRegisterDViewModels model, string value) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
                ...
                //ビジネスロジックから
                SelfDeclareRegisterDBL bl = new SelfDeclareRegisterDBL();
        ...
        public ActionResult SignCancel(SelfDeclareRegisterDViewModels model, string value) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        public ActionResult Save(SelfDeclareRegisterDViewModels model) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        //public ActionResult Save2Print(SelfDeclareRegisterDViewModels model) {
        //    try {
        //        //開始
        //        nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        public ActionResult Back(SelfDeclareRegisterDViewModels model, string value) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
                //検索画面へ
