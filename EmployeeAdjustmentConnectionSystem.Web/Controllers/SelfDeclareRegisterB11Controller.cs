...
namespace EmployeeAdjustmentConnectionSystem.Web.Controllers {
    ...
    /// 目標管理入力コントローラー
    /// </summary>
    public class SelfDeclareRegisterB11Controller : Controller {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        public ActionResult Index(int? id, string tableType) {
            try {
                ...
                //ビジネスロジックから取得
                //return View((new SelfDeclareRegisterB11BL(tableType)).Select(id));
                var bl = new SelfDeclareRegisterB11BL();
        ...
        public ActionResult Sign(SelfDeclareRegisterAtoCViewModels model, string value) {
            try {
                ...
                //ビジネスロジックから
                SelfDeclareRegisterB11BL bl = new SelfDeclareRegisterB11BL();
                ...
                ModelState.Clear();
                //再表示
                bl = new SelfDeclareRegisterB11BL();
                model = bl.Select(mNo);
                bl.SetMode(model, lu);
