...
using EmployeeAdjustmentConnectionSystem.BL.SystemManagement;
    ...
    public class SystemManagementController : Controller {
        ...
        public ActionResult DoBulk(SystemManagementModels model, string value) {
            try {
                ...
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"一括作成処理開始","目標・職能");
                ...
                // 2018-99-99 iwai-tamura upd str
                    ...
                    message = new SelfDeclareCreateBL().CreateSelfDeclare(model, value, (LoginUser)Session["LoginUser"]);
                // 2018-99-99 iwai-tamura upd end
                }
                ...
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"一括作成処理終了","目標・職能");
                //2019-10-02 iwai-tamura add-end ------
        ...
        public ActionResult DoDesignate(SystemManagementModels model, string value) {
            try {
                ...
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"個別作成処理開始","目標・職能");
                //2019-10-02 iwai-tamura add-end ------
                ...
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"個別作成処理終了","目標・職能");
                //2019-10-02 iwai-tamura add-end ------
        ...
        public ActionResult DoTakeOverMoveSingle_Reference(SystemManagementModels model, string value) {
            try {
                ...
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"データ引継ぎ開始","");
                //2019-10-02 iwai-tamura add-end ------
                ...
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"データ引継ぎ終了","");
                //2019-10-02 iwai-tamura add-end ------
        ...
        public ActionResult DoTakeOverMoveBulk(SystemManagementModels model, string value) {
            try {
                ...
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"データ一括引継ぎ開始","");
                //2019-10-02 iwai-tamura add-end ------
                ...
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"データ一括引継ぎ終了","");
                //2019-10-02 iwai-tamura add-end ------
        ...
        public ActionResult DoTakeOverMoveFormat(SystemManagementModels model) {
            try {
                ...
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"データ一括引継ぎ用format出力開始","");
                //2019-10-02 iwai-tamura add-end ------
                ...
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"データ一括引継ぎ用format出力終了","");
                //2019-10-02 iwai-tamura add-end ------
        ...
        public ActionResult DoTakeOverAmendmentCompany(SystemManagementModels model) {
            try {
                ...
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"データ引継開始","");
                //2019-10-02 iwai-tamura add-end ------
                ...
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"データ引継終了","");
                //2019-10-02 iwai-tamura add-end ------
        ...
        public ActionResult DoTakeOverAmendmentCompanyBulk(SystemManagementModels model, string value) {
            try {
                ...
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"一括データ引継開始","");
                //2019-10-02 iwai-tamura add-end ------
                ...
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"一括データ引継終了","");
                //2019-10-02 iwai-tamura add-end ------
        ...
        public ActionResult DoTakeOverAmendmentCompanyFormat(SystemManagementModels model) {
            try {
                ...
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"一括データ引継用format出力開始","");
                //2019-10-02 iwai-tamura add-end ------
                ...
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"一括データ引継用format出力終了","");
                //2019-10-02 iwai-tamura add-end ------
        ...
        public ActionResult DoCommit(SystemManagementModels model) {
            try {
                ...
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"確定処理開始","");
                //2019-10-02 iwai-tamura add-end ------
                ...
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"確定処理終了","");
                //2019-10-02 iwai-tamura add-end ------
        ...
        public ActionResult ResetPwd(SystemManagementModels model) {
            try {
                ...
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"パスワードリセット開始","");
                //2019-10-02 iwai-tamura add-end ------
                ...
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"パスワードリセット終了","");
                //2019-10-02 iwai-tamura add-end ------
        ...
        public ActionResult CreateInfo(SystemManagementModels model) {
            try {
                ...
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"お知らせ情報登録開始","");
                //2019-10-02 iwai-tamura add-end ------
                ...
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"お知らせ情報登録終了","");
                //2019-10-02 iwai-tamura add-end ------
        ...
        public ActionResult AddAccount(SystemManagementModels model)
        {
            try
            {
                ...
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"アカウント追加開始","");
                //2019-10-02 iwai-tamura add-end ------
            ...
            finally
            {
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"アカウント追加終了","");
                //2019-10-02 iwai-tamura add-end ------
        ...
        public ActionResult ConfirmPwd(SystemManagementModels model)
        {
            try
            {
                ...
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"パスワード確認開始","");
                //2019-10-02 iwai-tamura add-end ------
            ...
            finally
            {
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"パスワード確認終了","");
                //2019-10-02 iwai-tamura add-end ------
        ...
        public ActionResult Upload(SystemManagementModels model) {
            try {
                ...
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"決裁権限データアップロード開始","");
                //2019-10-02 iwai-tamura add-end ------
                ...
                switch (model.UploadTarget) { // アップロード対象
                    case "Objective": // 目標管理
                        ...
                        // 2018-04-09 iwai-tamura upd str ------
                        //ファイルチェック データ存在チェック
                        message = bl.ObjectiveApproverDataCheck(model, ReadData);
                        if (message!="") {
                            TempData["Confirmation"] = message;
                            break;
                        }
                        // 2018-04-09 iwai-tamura upd end ------
                    ...
                    case "Skill": // 職能判定
                        ...
                        // 2018-04-09 iwai-tamura upd str ------
                        //ファイルチェック データ存在チェック
                        message = bl.SkillApproverDataCheck(model, ReadData);
                        if (message!="") {
                            TempData["Confirmation"] = message;
                            break;
                        }
                    ...
                    case "Self": // 自己申告書
                        //ファイルチェック
                        if (bl.SelfDeclareApproverFileCheck(model, ReadData)==false) {
                            TempData["Confirmation"] = "ファイルの内容が正しくありません。確認してください。";
                            break;
                        }

                        //ファイルチェック データ存在チェック
                        message = bl.SelfDeclareApproverDataCheck(model, ReadData);
                        if (message!="") {
                            TempData["Confirmation"] = message;
                            break;
                        }
                        ...
                        // 目標管理決裁権限アップデート
                        if (bl.SelfDeclareApproverUpdate(model, ReadData)) {
                            TempData["Confirmation"] = "アップロードしました。";
                        } else {
                            TempData["Confirmation"] = "アップロードに失敗しました。";
                            break;
                    ...
                    case "Career": // キャリアシート
                        //ファイルチェック
                        if (bl.CareerSheetApproverFileCheck(model, ReadData)==false) {
                            TempData["Confirmation"] = "ファイルの内容が正しくありません。確認してください。";
                            break;
                        }

                        //ファイルチェック データ存在チェック
                        message = bl.CareerSheetApproverDataCheck(model, ReadData);
                        if (message!="") {
                            TempData["Confirmation"] = message;
                            break;
                        }
                        ...
                        // 目標管理決裁権限アップデート
                        if (bl.CareerSheetApproverUpdate(model, ReadData)) {
                            TempData["Confirmation"] = "アップロードしました。";
                        } else {
                            TempData["Confirmation"] = "アップロードに失敗しました。";
                            break;
                ...
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"決裁権限データアップロード終了","");
                //2019-10-02 iwai-tamura add-end ------
        ...
        public ActionResult ExcelOutput(SystemManagementModels model) {
            try {
                ...
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"決裁権限データ出力開始","");
                //2019-10-02 iwai-tamura add-end ------
                ...
                //終了
                //2019-10-02 iwai-tamura add-str ------
                CommonLog.WriteOperationLog((((LoginUser)Session["LoginUser"]).UserCode),"決裁権限データ出力終了","");
                //2019-10-02 iwai-tamura add-end ------
