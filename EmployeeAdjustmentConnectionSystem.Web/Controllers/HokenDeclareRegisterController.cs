...
using EmployeeAdjustmentConnectionSystem.BL.HokenDeclareRegister;
...
namespace EmployeeAdjustmentConnectionSystem.Web.Controllers {
    ...
    /// 扶養控除申告書入力コントローラー
    /// </summary>
    public class HokenDeclareRegisterController : Controller {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        public ActionResult Index(int? intSheetYear, string strEmployeeNo,bool bolAdminMode) {
            try {
                ...
                //ビジネスロジックから取得
                //return View((new HokenDeclareRegisterBL(tableType)).Select(id));
                var bl = new HokenDeclareRegisterBL();
        ...
        public ActionResult SignCancel(HokenDeclareRegisterViewModels model, string value) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
                ...
                //ビジネスロジックから
                HokenDeclareRegisterBL bl = new HokenDeclareRegisterBL();
        ...
        public ActionResult Save(HokenDeclareRegisterViewModels model) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        public ActionResult Keep(HokenDeclareRegisterViewModels model) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        public ActionResult Back(HokenDeclareRegisterViewModels model, string value) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
                //トップへ
