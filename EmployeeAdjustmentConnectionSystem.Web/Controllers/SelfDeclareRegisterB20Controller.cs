...
namespace EmployeeAdjustmentConnectionSystem.Web.Controllers {
    ...
    /// 目標管理入力コントローラー
    /// </summary>
    public class SelfDeclareRegisterB20Controller : Controller {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        public ActionResult Index(int? id, string tableType) {
            try {
                ...
                //ビジネスロジックから取得
                //return View((new SelfDeclareRegisterB20BL(tableType)).Select(id));
                var bl = new SelfDeclareRegisterB20BL();
        ...
        public ActionResult Sign(SelfDeclareRegisterAtoCViewModels model, string value) {
            try {
                ...
                //ビジネスロジックから
                SelfDeclareRegisterB20BL bl = new SelfDeclareRegisterB20BL();
                ...
                ModelState.Clear();
                //再表示
                bl = new SelfDeclareRegisterB20BL();
                model = bl.Select(mNo);
                bl.SetMode(model, lu);
