...
namespace EmployeeAdjustmentConnectionSystem.BL.SelfDeclareRegister {
    ...
    /// 目標管理入力ビジネスロジック
    /// </summary>
    public class SelfDeclareRegisterB12BL {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        /// デフォルトコンストラクタ
        /// </summary>
        public SelfDeclareRegisterB12BL() {
        }
                    ...
                    using(DataSet ds = new DataSet()) {
                        ...
                        foreach(DataRow row in rows) {
                            model.Body = new SelfDeclareRegisterAtoCBodyModel {
                                ...
                                AptitudeDevelop_1_1_1 = selectMainte(row["適性能力開発区分_1_1_1"].ToString() + ":" + row["適性能力開発内容_1_1_1"].ToString()),
                                AptitudeDevelop_1_1_1_Content = row["適性能力開発内容_1_1_1"].ToString(),
                                AptitudeDevelop_1_1_2 = selectMainte(row["適性能力開発区分_1_1_2"].ToString() + ":" + row["適性能力開発内容_1_1_2"].ToString()),
                                AptitudeDevelop_1_1_2_Content = row["適性能力開発内容_1_1_2"].ToString(),
                                AptitudeDevelop_1_1_Other = row["適性能力開発内容_1_1_Other"].ToString(),
                                AptitudeDevelop_1_2_1 = selectMainte(row["適性能力開発区分_1_2_1"].ToString() + ":" + row["適性能力開発内容_1_2_1"].ToString()),
                                AptitudeDevelop_1_2_1_Content = row["適性能力開発内容_1_2_1"].ToString(),
                                AptitudeDevelop_1_2_2 = selectMainte(row["適性能力開発区分_1_2_2"].ToString() + ":" + row["適性能力開発内容_1_2_2"].ToString()),
                                AptitudeDevelop_1_2_2_Content = row["適性能力開発内容_1_2_2"].ToString(),
                                AptitudeDevelop_1_2_Other = row["適性能力開発内容_1_2_Other"].ToString(),
                                AptitudeDevelop_2_Content = row["適性能力開発内容_2"].ToString(),
                                TransferDutyDepartment_1_Content = row["職務変更配置換内容_1"].ToString(),
                                TransferDutyDepartment_1_1 = selectMainte(row["職務変更配置換区分_1_1"].ToString() + ":" + row["職務変更配置換内容_1_1"].ToString()),
                                TransferDutyDepartment_1_1_Content = row["職務変更配置換内容_1_1"].ToString(),
                                TransferDutyDepartment_1_1_Other = row["職務変更配置換内容_1_1_Other"].ToString(),
                                TransferDutyDepartment_1_2 = selectMainte(row["職務変更配置換区分_1_2"].ToString() + ":" + row["職務変更配置換内容_1_2"].ToString()),
                                TransferDutyDepartment_1_2_Content = row["職務変更配置換内容_1_2"].ToString(),
                                TransferDutyDepartment_1_2_Other = row["職務変更配置換内容_1_2_Other"].ToString(),
                                TransferDutyDepartment_2_1 = selectMainte(row["職務変更配置換区分_2_1"].ToString() + ":" +row["職務変更配置換内容_2_1"].ToString()),
                                TransferDutyDepartment_2_1_Content = row["職務変更配置換内容_2_1"].ToString(),
                                TransferDutyDepartment_2_2 = selectMainte(row["職務変更配置換区分_2_2"].ToString() + ":" +row["職務変更配置換内容_2_2"].ToString()),
                                TransferDutyDepartment_2_2_Content = row["職務変更配置換内容_2_2"].ToString(),
                                TransferDutyDepartment_2_3 = selectMainte(row["職務変更配置換区分_2_3"].ToString() + ":" +row["職務変更配置換内容_2_3"].ToString()),
                                TransferDutyDepartment_2_3_Content = row["職務変更配置換内容_2_3"].ToString(),
                                TransferDutyDepartment_2_Other = row["職務変更配置換内容_2_Other"].ToString(),
                            ...
                            //SelfDeclareRegisterAListModel list = new SelfDeclareRegisterAListModel {
                            //    ChargeDuty_1 = row["担当職務_1"].ToString()
            ...
            try {
                ...
                using(var scope = new TransactionScope()) {
                    using(var dm = new DbManager()) {
                        ...
                        //詳細内容
                        sql = "update SD_T自己申告書明細DataB12"
                            + " set "
                            + " 担当職務_1 = @ChargeDuty_1"
                            + " ,担当職務_2 = @ChargeDuty_2"
                            + " ,担当職務_3 = @ChargeDuty_3"
                            + " ,適性能力開発区分_1_1_1 = @AptitudeDevelop_1_1_1"
                            + " ,適性能力開発内容_1_1_1 = @AptitudeDevelop_1_1_1_Content"
                            + " ,適性能力開発区分_1_1_2 = @AptitudeDevelop_1_1_2"
                            + " ,適性能力開発内容_1_1_2 = @AptitudeDevelop_1_1_2_Content"
                            + " ,適性能力開発内容_1_1_Other = @AptitudeDevelop_1_1_Other"
                            + " ,適性能力開発区分_1_2_1 = @AptitudeDevelop_1_2_1"
                            + " ,適性能力開発内容_1_2_1 = @AptitudeDevelop_1_2_1_Content"
                            + " ,適性能力開発区分_1_2_2 = @AptitudeDevelop_1_2_2"
                            + " ,適性能力開発内容_1_2_2 = @AptitudeDevelop_1_2_2_Content"
                            + " ,適性能力開発内容_1_2_Other = @AptitudeDevelop_1_2_Other"
                            + " ,適性能力開発内容_2 = @AptitudeDevelop_2_Content"
                            + " ,職務変更配置換内容_1 = @TransferDutyDepartment_1_Content"
                            + " ,職務変更配置換区分_1_1 = @TransferDutyDepartment_1_1"
                            + " ,職務変更配置換内容_1_1 = @TransferDutyDepartment_1_1_Content"
                            + " ,職務変更配置換内容_1_1_Other = @TransferDutyDepartment_1_1_Other"
                            + " ,職務変更配置換区分_1_2 = @TransferDutyDepartment_1_2"
                            + " ,職務変更配置換内容_1_2 = @TransferDutyDepartment_1_2_Content"
                            + " ,職務変更配置換内容_1_2_Other = @TransferDutyDepartment_1_2_Other"
                            + " ,職務変更配置換区分_2_1 = @TransferDutyDepartment_2_1"
                            + " ,職務変更配置換内容_2_1 = @TransferDutyDepartment_2_1_Content"
                            + " ,職務変更配置換区分_2_2 = @TransferDutyDepartment_2_2"
                            + " ,職務変更配置換内容_2_2 = @TransferDutyDepartment_2_2_Content"
                            + " ,職務変更配置換区分_2_3 = @TransferDutyDepartment_2_3"
                            + " ,職務変更配置換内容_2_3 = @TransferDutyDepartment_2_3_Content"
                            + " ,職務変更配置換内容_2_Other = @TransferDutyDepartment_2_Other"
                        ...
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_1_1_1", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_1_1_1_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_1_1_2", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_1_1_2_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_1_1_Other", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_1_2_1", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_1_2_1_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_1_2_2", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_1_2_2_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_1_2_Other", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_2_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDutyDepartment_1_Content", DbType.String);
                        ...
                        DbHelper.AddDbParameter(cmd, "@TransferDutyDepartment_1_1_Other", DbType.String);
                        ...
                        DbHelper.AddDbParameter(cmd, "@TransferDutyDepartment_1_2_Other", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDutyDepartment_2_1", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDutyDepartment_2_1_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDutyDepartment_2_2", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDutyDepartment_2_2_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDutyDepartment_2_3", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDutyDepartment_2_3_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDutyDepartment_2_Other", DbType.String);
                        ...
                        parameters[2].Value = DataConv.IfNull(model.Body.ChargeDuty_2);
                        parameters[3].Value = DataConv.IfNull(model.Body.ChargeDuty_3);
                        parameters[4].Value = DataConv.IfNull(splitPre(model.Body.AptitudeDevelop_1_1_1));
                        parameters[5].Value = DataConv.IfNull(splitSuf(model.Body.AptitudeDevelop_1_1_1));
                        parameters[6].Value = DataConv.IfNull(splitPre(model.Body.AptitudeDevelop_1_1_2));
                        parameters[7].Value = DataConv.IfNull(splitSuf(model.Body.AptitudeDevelop_1_1_2));
                        parameters[8].Value = DataConv.IfNull(model.Body.AptitudeDevelop_1_1_Other);
                        parameters[9].Value = DataConv.IfNull(splitPre(model.Body.AptitudeDevelop_1_2_1));
                        parameters[10].Value = DataConv.IfNull(splitSuf(model.Body.AptitudeDevelop_1_2_1));
                        parameters[11].Value = DataConv.IfNull(splitPre(model.Body.AptitudeDevelop_1_2_2));
                        parameters[12].Value = DataConv.IfNull(splitSuf(model.Body.AptitudeDevelop_1_2_2));
                        parameters[13].Value = DataConv.IfNull(model.Body.AptitudeDevelop_1_2_Other);
                        parameters[14].Value = DataConv.IfNull(model.Body.AptitudeDevelop_2_Content);
                        parameters[15].Value = DataConv.IfNull(model.Body.TransferDutyDepartment_1_Content);
                        parameters[16].Value = DataConv.IfNull(splitPre(model.Body.TransferDutyDepartment_1_1));
                        parameters[17].Value = DataConv.IfNull(splitSuf(model.Body.TransferDutyDepartment_1_1));
                        parameters[18].Value = DataConv.IfNull(model.Body.TransferDutyDepartment_1_1_Other);
                        parameters[19].Value = DataConv.IfNull(splitPre(model.Body.TransferDutyDepartment_1_2));
                        parameters[20].Value = DataConv.IfNull(splitSuf(model.Body.TransferDutyDepartment_1_2));
                        parameters[21].Value = DataConv.IfNull(model.Body.TransferDutyDepartment_1_2_Other);
                        parameters[22].Value = DataConv.IfNull(splitPre(model.Body.TransferDutyDepartment_2_1));
                        parameters[23].Value = DataConv.IfNull(splitSuf(model.Body.TransferDutyDepartment_2_1));
                        parameters[24].Value = DataConv.IfNull(splitPre(model.Body.TransferDutyDepartment_2_2));
                        parameters[25].Value = DataConv.IfNull(splitSuf(model.Body.TransferDutyDepartment_2_2));
                        parameters[26].Value = DataConv.IfNull(splitPre(model.Body.TransferDutyDepartment_2_3));
                        parameters[27].Value = DataConv.IfNull(splitSuf(model.Body.TransferDutyDepartment_2_3));
                        parameters[28].Value = DataConv.IfNull(model.Body.TransferDutyDepartment_2_Other);
                        parameters[29].Value = DataConv.IfNull(model.Body.AptitudeDevelop_1_1);
                        parameters[30].Value = DataConv.IfNull(splitPre(model.Body.AptitudeDevelop_1_2));
                        parameters[31].Value = DataConv.IfNull(splitSuf(model.Body.AptitudeDevelop_1_2));
                        parameters[32].Value = DataConv.IfNull(model.Body.AptitudeDevelop_1_3);
                        parameters[33].Value = DataConv.IfNull(model.Body.AptitudeDevelop_2);
                        parameters[34].Value = DataConv.IfNull(model.Body.AptitudeDevelop_3);
                        parameters[35].Value = DataConv.IfNull(model.Body.FreeComment);
                        parameters[36].Value = DataConv.IfNull(model.Body.BossComment);
