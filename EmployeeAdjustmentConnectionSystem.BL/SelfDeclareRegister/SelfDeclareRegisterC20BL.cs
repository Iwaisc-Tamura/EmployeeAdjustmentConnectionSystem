...
namespace EmployeeAdjustmentConnectionSystem.BL.SelfDeclareRegister {
    ...
    /// 目標管理入力ビジネスロジック
    /// </summary>
    public class SelfDeclareRegisterC20BL {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        /// デフォルトコンストラクタ
        /// </summary>
        public SelfDeclareRegisterC20BL() {
        }
            ...
            try {
                ...
                using(var scope = new TransactionScope()) {
                    using(var dm = new DbManager()) {
                        ...
                        parameters[9].Value = DataConv.IfNull(model.Body.OldLifeComment1);
                        parameters[10].Value = DataConv.IfNull(model.Body.FreeComment);
                        parameters[11].Value = DataConv.IfNull(model.Body.BossComment);
