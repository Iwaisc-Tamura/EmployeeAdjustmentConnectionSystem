...
namespace EmployeeAdjustmentConnectionSystem.BL.SelfDeclareRegister {
    ...
    /// 目標管理入力ビジネスロジック
    /// </summary>
    public class SelfDeclareRegisterB20BL {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        /// デフォルトコンストラクタ
        /// </summary>
        public SelfDeclareRegisterB20BL() {
        }
                ...
                using(DbManager dm = new DbManager()) {
                    ...
                    using(DataSet ds = new DataSet()) {
                        ...
                        foreach(DataRow row in rows) {
                            ...
                            ChargeDuty_2_8 = selectMainte(row["担当職務区分_2_8"].ToString() + ":" + row["担当職務内容_2_8"].ToString()),
                            ChargeDuty_2_8_Content = row["担当職務内容_2_8"].ToString(),
                ...
                using(var scope = new TransactionScope()) {
                    using(var dm = new DbManager()) {
                        ...
                        sql = "update SD_T自己申告書明細DataB20"
                            ...
                            + " ,担当職務区分_2_8 = @ChargeDuty_2_8"
                            + " ,担当職務内容_2_8 = @ChargeDuty_2_8_Content"
                            + " ,担当職務_3 = @ChargeDuty_3"
                            + " ,担当職務_4 = @ChargeDuty_4"
                        ...
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_8", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_8_Content", DbType.String);
                        ...
                        parameters[16].Value = DataConv.IfNull(splitPre(model.Body.ChargeDuty_2_8));
                        parameters[17].Value = DataConv.IfNull(splitSuf(model.Body.ChargeDuty_2_8));
                        parameters[18].Value = DataConv.IfNull(model.Body.ChargeDuty_3);
                        parameters[19].Value = DataConv.IfNull(model.Body.ChargeDuty_4);
                        ...
                        parameters[65].Value = DataConv.IfNull(model.Body.OldLifeComment1);
                        parameters[66].Value = DataConv.IfNull(model.Body.FreeComment);
                        parameters[67].Value = DataConv.IfNull(model.Body.BossComment);
