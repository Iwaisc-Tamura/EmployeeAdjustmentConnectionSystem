...
namespace EmployeeAdjustmentConnectionSystem.BL.SelfDeclareRegister {
    ...
    /// 目標管理入力ビジネスロジック
    /// </summary>
    public class SelfDeclareRegisterA13BL {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        /// デフォルトコンストラクタ
        /// </summary>
        public SelfDeclareRegisterA13BL() {
        }
        ...
        public SelfDeclareRegisterAtoCViewModels Select(int? id) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");

                SelfDeclareRegisterAtoCViewModels model = new SelfDeclareRegisterAtoCViewModels();
                model.Head = new SelfDeclareRegisterAtoCHeaderModel();
                model.Body = new SelfDeclareRegisterAtoCBodyModel();
                ...
                using(DbManager dm = new DbManager()) {
                    ...
                    using(DataSet ds = new DataSet()) {
                        ...
                        foreach(DataRow row in rows) {
                            ...
                            ChargeDuty_2_1 = selectMainte(row["担当職務区分_2_1"].ToString() + ":" + row["担当職務内容_2_1"].ToString()),
                            ChargeDuty_2_1_Content = row["担当職務内容_2_1"].ToString(),
                            ChargeDuty_2_2 = selectMainte(row["担当職務区分_2_2"].ToString() + ":" + row["担当職務内容_2_2"].ToString()),
                            ChargeDuty_2_2_Content = row["担当職務内容_2_2"].ToString(),
                            ChargeDuty_2_3 = selectMainte(row["担当職務区分_2_3"].ToString() + ":" + row["担当職務内容_2_3"].ToString()),
                            ChargeDuty_2_3_Content = row["担当職務内容_2_3"].ToString(),
                            ChargeDuty_2_4 = selectMainte(row["担当職務区分_2_4"].ToString() + ":" + row["担当職務内容_2_4"].ToString()),
                            ChargeDuty_2_4_Content = row["担当職務内容_2_4"].ToString(),
                            ChargeDuty_2_5 = selectMainte(row["担当職務区分_2_5"].ToString() + ":" + row["担当職務内容_2_5"].ToString()),
                            ChargeDuty_2_5_Content = row["担当職務内容_2_5"].ToString(),
                            ChargeDuty_2_6 = selectMainte(row["担当職務区分_2_6"].ToString() + ":" + row["担当職務内容_2_6"].ToString()),
                            ChargeDuty_2_6_Content = row["担当職務内容_2_6"].ToString(),
                            ChargeDuty_2_7 = selectMainte(row["担当職務区分_2_7"].ToString() + ":" + row["担当職務内容_2_7"].ToString()),
                            ChargeDuty_2_7_Content = row["担当職務内容_2_7"].ToString(),
                            ChargeDuty_3 = row["担当職務_3"].ToString(),
                            ChargeDuty_4 = row["担当職務_4"].ToString(),
                            ChargeDuty_5 = row["担当職務_5"].ToString(),
                            ChargeDuty_6 = row["担当職務_6"].ToString(),
                            Aptitude_1_1_1 = selectMainte(row["適性区分_1_1_1"].ToString() + ":" + row["適性内容_1_1_1"].ToString()),
                            Aptitude_1_1_1_Content = row["適性内容_1_1_1"].ToString(),
                            Aptitude_1_1_2 = selectMainte(row["適性区分_1_1_2"].ToString() + ":" + row["適性内容_1_1_2"].ToString()),
                            Aptitude_1_1_2_Content = row["適性内容_1_1_2"].ToString(),
                            Aptitude_1_1_Other = row["適性内容_1_1_Other"].ToString(),
                            Aptitude_1_2_1 = selectMainte(row["適性区分_1_2_1"].ToString() + ":" + row["適性内容_1_2_1"].ToString()),
                            Aptitude_1_2_1_Content = row["適性内容_1_2_1"].ToString(),
                            Aptitude_1_2_2 = selectMainte(row["適性区分_1_2_2"].ToString() + ":" + row["適性内容_1_2_2"].ToString()),
                            Aptitude_1_2_2_Content = row["適性内容_1_2_2"].ToString(),
                            Aptitude_1_2_Other = row["適性内容_1_2_Other"].ToString(),
                            Aptitude_2_1_Duty = row["適性職務内容_2_1"].ToString(),
                            Aptitude_2_1_License = row["適性資格免許_2_1"].ToString(),
                            Aptitude_2_1_Level = selectMainte(row["適性遂行Level区分_2_1"].ToString() + ":" + row["適性遂行Level内容_2_1"].ToString()),
                            Aptitude_2_1_Level_Content = row["適性遂行Level内容_2_1"].ToString(),
                            Aptitude_2_2_Duty = row["適性職務内容_2_2"].ToString(),
                            Aptitude_2_2_License = row["適性資格免許_2_2"].ToString(),
                            Aptitude_2_2_Level = selectMainte(row["適性遂行Level区分_2_2"].ToString() + ":" + row["適性遂行Level内容_2_2"].ToString()),
                            Aptitude_2_2_Level_Content = row["適性遂行Level内容_2_2"].ToString(),
                            Aptitude_2_3_Duty = row["適性職務内容_2_3"].ToString(),
                            Aptitude_2_3_License = row["適性資格免許_2_3"].ToString(),
                            Aptitude_2_3_Level = selectMainte(row["適性遂行Level区分_2_3"].ToString() + ":" + row["適性遂行Level内容_2_3"].ToString()),
                            Aptitude_2_3_Level_Content = row["適性遂行Level内容_2_3"].ToString(),
                            Aptitude_2_4_Duty = row["適性職務内容_2_4"].ToString(),
                            Aptitude_2_4_License = row["適性資格免許_2_4"].ToString(),
                            Aptitude_2_4_Level = selectMainte(row["適性遂行Level区分_2_4"].ToString() + ":" + row["適性遂行Level内容_2_4"].ToString()),
                            Aptitude_2_4_Level_Content = row["適性遂行Level内容_2_4"].ToString(),
                            Aptitude_2_5_Duty = row["適性職務内容_2_5"].ToString(),
                            Aptitude_2_5_License = row["適性資格免許_2_5"].ToString(),
                            Aptitude_2_5_Level = selectMainte(row["適性遂行Level区分_2_5"].ToString() + ":" + row["適性遂行Level内容_2_5"].ToString()),
                            Aptitude_2_5_Level_Content = row["適性遂行Level内容_2_5"].ToString(),
                            Aptitude_3 = row["適性_3"].ToString(),
                            TransferDepartment_1 = row["配置換_1"].ToString(),
                            TransferDepartment_1_1 = selectMainte(row["配置換区分_1_1"].ToString() + ":" + row["配置換内容_1_1"].ToString()),
                            TransferDepartment_1_1_Content = row["配置換内容_1_1"].ToString(),
                            TransferDepartment_1_1_Other = row["配置換内容_1_1_Other"].ToString(),
                            TransferDepartment_1_2 = selectMainte(row["配置換区分_1_2"].ToString() + ":" + row["配置換内容_1_2"].ToString()),
                            TransferDepartment_1_2_Content = row["配置換内容_1_2"].ToString(),
                            TransferDepartment_1_2_Other = row["配置換内容_1_2_Other"].ToString(),
                            TransferDepartment_2_1 = selectMainte(row["配置換区分_2_1"].ToString() + ":" + row["配置換内容_2_1"].ToString()),
                            TransferDepartment_2_1_Content = row["配置換内容_2_1"].ToString(),
                            ...
                            AptitudeDevelop_1_1 = row["能力開発_1_1"].ToString(),
                            AptitudeDevelop_1_2 = selectMainte(row["能力開発区分_1_2"].ToString() + ":" + row["能力開発内容_1_2"].ToString()),
                            AptitudeDevelop_1_2_Content = row["能力開発内容_1_2"].ToString(),
                            AptitudeDevelop_1_3 = row["能力開発_1_3"].ToString(),
                            AptitudeDevelop_2 = row["能力開発_2"].ToString(),
                            AptitudeDevelop_3 = row["能力開発_3"].ToString(),
                            FreeComment = row["自由意見内容"].ToString(),
                            BossComment = row["上司記入欄内容"].ToString()

                            };

                            //SelfDeclareRegisterBListModel list = new SelfDeclareRegisterBListModel {
                            //    ChargeDuty_1 = row["担当職務_1"].ToString()
                            //    //AreaNo = DataConv.IntParse(row["区分番号"].ToString()),
                            //    //AreaSel = (Area)DataConv.IntParse(row["目標区分"].ToString(), 0),
                            //    //ObjItem = row["目標項目"].ToString(),
                            //    //AchvLevel = row["達成水準期限"].ToString(),
                            //    //ObjPolicys = row["目標達成施策手段"].ToString(),
                            //    //BestMetrics = row["評価基準大幅達成"].ToString(),
                            //    //BetterMetrics = row["評価基準達成"].ToString(),
                            //    //SelfWeight = row["ウェイト本人"].ToString(),
                            //    //BossWeight = row["ウェイト上司"].ToString(),
                            //    //SelfComment = row["本人評価コメント"].ToString(),
                            //    //SelfAchv = row["本人評価達成度"].ToString(),
                            //    //SelfProcess = row["本人評価プロセス"].ToString(),
                            //    //BossComment = row["上司評価コメント"].ToString(),
                            //    //BossAchv = row["上司評価達成度"].ToString(),
                            //    //BossProcess = row["上司評価プロセス"].ToString(),
                            //    //AchvTotal = row["評価点達成度"].ToString(),
                            //    //ProcessTotal = row["評価点プロセス"].ToString()
                            //};
                        }
                    }
                }
        ...
        public void SetMode(SelfDeclareRegisterAtoCViewModels model, LoginUser lu) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        private void SetRootCancel(DbManager dm, SelfDeclareRegisterAtoCViewModels model
        ...
        /// <param name="lu">ログインユーザー</param>
        /// <param name="mode">承認状態</param>
        private void SetInputSignMode(DbManager dm, SelfDeclareRegisterAtoCViewModels model
            , LoginUser lu, SelfDeclareMode mode) {
            var sql = "select"
                    + " 管理番号"
                    + ",年度"
            ...
            using(DataSet ds = new DataSet()) {
                ...
                //モード設定
                Func<SelfDeclareRegisterAtoCViewModels, string, SelfDeclareMode, bool> setMode = (m, u, om) => {
        ...
        public void Save(SelfDeclareRegisterAtoCViewModels model) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
                ...
                using(var scope = new TransactionScope()) {
                    using(var dm = new DbManager()) {
                        ...
                        //詳細内容
                        sql = "update SD_T自己申告書明細DataA13"
                            + " set "
                            + "  担当職務_1 = @ChargeDuty_1"
                            + " ,担当職務区分_2_1 = @ChargeDuty_2_1"
                            + " ,担当職務内容_2_1 = @ChargeDuty_2_1_Content"
                            + " ,担当職務区分_2_2 = @ChargeDuty_2_2"
                            + " ,担当職務内容_2_2 = @ChargeDuty_2_2_Content"
                            + " ,担当職務区分_2_3 = @ChargeDuty_2_3"
                            + " ,担当職務内容_2_3 = @ChargeDuty_2_3_Content"
                            + " ,担当職務区分_2_4 = @ChargeDuty_2_4"
                            + " ,担当職務内容_2_4 = @ChargeDuty_2_4_Content"
                            + " ,担当職務区分_2_5 = @ChargeDuty_2_5"
                            + " ,担当職務内容_2_5 = @ChargeDuty_2_5_Content"
                            + " ,担当職務区分_2_6 = @ChargeDuty_2_6"
                            + " ,担当職務内容_2_6 = @ChargeDuty_2_6_Content"
                            + " ,担当職務区分_2_7 = @ChargeDuty_2_7"
                            + " ,担当職務内容_2_7 = @ChargeDuty_2_7_Content"
                            + " ,担当職務_3 = @ChargeDuty_3"
                            + " ,担当職務_4 = @ChargeDuty_4"
                            + " ,担当職務_5 = @ChargeDuty_5"
                            + " ,担当職務_6 = @ChargeDuty_6"
                            + " ,適性区分_1_1_1 = @Aptitude_1_1_1"
                            + " ,適性内容_1_1_1 = @Aptitude_1_1_1_Content"
                            + " ,適性区分_1_1_2 = @Aptitude_1_1_2"
                            + " ,適性内容_1_1_2 = @Aptitude_1_1_2_Content"
                            + " ,適性内容_1_1_Other = @Aptitude_1_1_Other"
                            + " ,適性区分_1_2_1 = @Aptitude_1_2_1"
                            + " ,適性内容_1_2_1 = @Aptitude_1_2_1_Content"
                            + " ,適性区分_1_2_2 = @Aptitude_1_2_2"
                            + " ,適性内容_1_2_2 = @Aptitude_1_2_2_Content"
                            + " ,適性内容_1_2_Other = @Aptitude_1_2_Other"
                            + " ,適性職務内容_2_1 = @Aptitude_2_1_Duty"
                            + " ,適性資格免許_2_1 = @Aptitude_2_1_License"
                            + " ,適性遂行Level区分_2_1 = @Aptitude_2_1_Level"
                            + " ,適性遂行Level内容_2_1 = @Aptitude_2_1_Level_Content"
                            + " ,適性職務内容_2_2 = @Aptitude_2_2_Duty"
                            + " ,適性資格免許_2_2 = @Aptitude_2_2_License"
                            + " ,適性遂行Level区分_2_2 = @Aptitude_2_2_Level"
                            + " ,適性遂行Level内容_2_2 = @Aptitude_2_2_Level_Content"
                            + " ,適性職務内容_2_3 = @Aptitude_2_3_Duty"
                            + " ,適性資格免許_2_3 = @Aptitude_2_3_License"
                            + " ,適性遂行Level区分_2_3 = @Aptitude_2_3_Level"
                            + " ,適性遂行Level内容_2_3 = @Aptitude_2_3_Level_Content"
                            + " ,適性職務内容_2_4 = @Aptitude_2_4_Duty"
                            + " ,適性資格免許_2_4 = @Aptitude_2_4_License"
                            + " ,適性遂行Level区分_2_4 = @Aptitude_2_4_Level"
                            + " ,適性遂行Level内容_2_4 = @Aptitude_2_4_Level_Content"
                            + " ,適性職務内容_2_5 = @Aptitude_2_5_Duty"
                            + " ,適性資格免許_2_5 = @Aptitude_2_5_License"
                            + " ,適性遂行Level区分_2_5 = @Aptitude_2_5_Level"
                            + " ,適性遂行Level内容_2_5 = @Aptitude_2_5_Level_Content"
                            + " ,適性_3 = @Aptitude_3"
                            + " ,配置換_1 = @TransferDepartment_1"
                            + " ,配置換区分_1_1 = @TransferDepartment_1_1"
                            + " ,配置換内容_1_1 = @TransferDepartment_1_1_Content"
                            + " ,配置換内容_1_1_Other = @TransferDepartment_1_1_Other"
                            + " ,配置換区分_1_2 = @TransferDepartment_1_2"
                            + " ,配置換内容_1_2 = @TransferDepartment_1_2_Content"
                            + " ,配置換内容_1_2_Other = @TransferDepartment_1_2_Other"
                            + " ,配置換区分_2_1 = @TransferDepartment_2_1"
                            + " ,配置換内容_2_1 = @TransferDepartment_2_1_Content"
                            ...
                            + " ,能力開発_1_1 = @AptitudeDevelop_1_1"
                            + " ,能力開発区分_1_2 = @AptitudeDevelop_1_2"
                            + " ,能力開発内容_1_2 = @AptitudeDevelop_1_2_Content"
                            + " ,能力開発_1_3 = @AptitudeDevelop_1_3"
                            + " ,能力開発_2 = @AptitudeDevelop_2"
                            + " ,能力開発_3 = @AptitudeDevelop_3"
                            + " ,自由意見内容 = @FreeComment"
                            + " ,上司記入欄内容 = @BossComment"
                        ...
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_1", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_1_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_2", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_2_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_3", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_3_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_4", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_4_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_5", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_5_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_6", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_6_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_7", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_2_7_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_3", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_4", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_5", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@ChargeDuty_6", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_1_1_1", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_1_1_1_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_1_1_2", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_1_1_2_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_1_1_Other", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_1_2_1", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_1_2_1_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_1_2_2", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_1_2_2_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_1_2_Other", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_1_Duty", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_1_License", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_1_Level", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_1_Level_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_2_Duty", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_2_License", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_2_Level", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_2_Level_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_3_Duty", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_3_License", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_3_Level", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_3_Level_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_4_Duty", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_4_License", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_4_Level", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_4_Level_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_5_Duty", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_5_License", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_5_Level", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_2_5_Level_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@Aptitude_3", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDepartment_1", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDepartment_1_1", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDepartment_1_1_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDepartment_1_1_Other", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDepartment_1_2", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDepartment_1_2_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDepartment_1_2_Other", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDepartment_2_1", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@TransferDepartment_2_1_Content", DbType.String);
                        ...
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_1_1", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_1_2", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_1_2_Content", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_1_3", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_2", DbType.String);
                        DbHelper.AddDbParameter(cmd, "@AptitudeDevelop_3", DbType.String);
                        ...
                        parameters[0].Value = DataConv.IfNull(model.Head.ManageNo);
                        parameters[1].Value = DataConv.IfNull(model.Body.ChargeDuty_1);
                        parameters[2].Value = DataConv.IfNull(splitPre(model.Body.ChargeDuty_2_1));
                        parameters[3].Value = DataConv.IfNull(splitSuf(model.Body.ChargeDuty_2_1));
                        parameters[4].Value = DataConv.IfNull(splitPre(model.Body.ChargeDuty_2_2));
                        parameters[5].Value = DataConv.IfNull(splitSuf(model.Body.ChargeDuty_2_2));
                        parameters[6].Value = DataConv.IfNull(splitPre(model.Body.ChargeDuty_2_3));
                        parameters[7].Value = DataConv.IfNull(splitSuf(model.Body.ChargeDuty_2_3));
                        parameters[8].Value = DataConv.IfNull(splitPre(model.Body.ChargeDuty_2_4));
                        parameters[9].Value = DataConv.IfNull(splitSuf(model.Body.ChargeDuty_2_4));
                        parameters[10].Value = DataConv.IfNull(splitPre(model.Body.ChargeDuty_2_5));
                        parameters[11].Value = DataConv.IfNull(splitSuf(model.Body.ChargeDuty_2_5));
                        parameters[12].Value = DataConv.IfNull(splitPre(model.Body.ChargeDuty_2_6));
                        parameters[13].Value = DataConv.IfNull(splitSuf(model.Body.ChargeDuty_2_6));
                        parameters[14].Value = DataConv.IfNull(splitPre(model.Body.ChargeDuty_2_7));
                        parameters[15].Value = DataConv.IfNull(splitSuf(model.Body.ChargeDuty_2_7));
                        parameters[16].Value = DataConv.IfNull(model.Body.ChargeDuty_3);
                        parameters[17].Value = DataConv.IfNull(model.Body.ChargeDuty_4);
                        parameters[18].Value = DataConv.IfNull(model.Body.ChargeDuty_5);
                        parameters[19].Value = DataConv.IfNull(model.Body.ChargeDuty_6);
                        parameters[20].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_1_1_1));
                        parameters[21].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_1_1_1));
                        parameters[22].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_1_1_2));
                        parameters[23].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_1_1_2));
                        parameters[24].Value = DataConv.IfNull(model.Body.Aptitude_1_1_Other);
                        parameters[25].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_1_2_1));
                        parameters[26].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_1_2_1));
                        parameters[27].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_1_2_2));
                        parameters[28].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_1_2_2));
                        parameters[29].Value = DataConv.IfNull(model.Body.Aptitude_1_2_Other);
                        parameters[30].Value = DataConv.IfNull(model.Body.Aptitude_2_1_Duty);
                        parameters[31].Value = DataConv.IfNull(model.Body.Aptitude_2_1_License);
                        parameters[32].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_2_1_Level));
                        parameters[33].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_2_1_Level));
                        parameters[34].Value = DataConv.IfNull(model.Body.Aptitude_2_2_Duty);
                        parameters[35].Value = DataConv.IfNull(model.Body.Aptitude_2_2_License);
                        parameters[36].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_2_2_Level));
                        parameters[37].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_2_2_Level));
                        parameters[38].Value = DataConv.IfNull(model.Body.Aptitude_2_3_Duty);
                        parameters[39].Value = DataConv.IfNull(model.Body.Aptitude_2_3_License);
                        parameters[40].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_2_3_Level));
                        parameters[41].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_2_3_Level));
                        parameters[42].Value = DataConv.IfNull(model.Body.Aptitude_2_4_Duty);
                        parameters[43].Value = DataConv.IfNull(model.Body.Aptitude_2_4_License);
                        parameters[44].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_2_4_Level));
                        parameters[45].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_2_4_Level));
                        parameters[46].Value = DataConv.IfNull(model.Body.Aptitude_2_5_Duty);
                        parameters[47].Value = DataConv.IfNull(model.Body.Aptitude_2_5_License);
                        parameters[48].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_2_5_Level));
                        parameters[49].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_2_5_Level));
                        parameters[50].Value = DataConv.IfNull(model.Body.Aptitude_3);
                        parameters[51].Value = DataConv.IfNull(model.Body.TransferDepartment_1);
                        parameters[52].Value = DataConv.IfNull(splitPre(model.Body.TransferDepartment_1_1));
                        parameters[53].Value = DataConv.IfNull(splitSuf(model.Body.TransferDepartment_1_1));
                        parameters[54].Value = DataConv.IfNull(model.Body.TransferDepartment_1_1_Other);
                        parameters[55].Value = DataConv.IfNull(splitPre(model.Body.TransferDepartment_1_2));
                        parameters[56].Value = DataConv.IfNull(splitSuf(model.Body.TransferDepartment_1_2));
                        parameters[57].Value = DataConv.IfNull(model.Body.TransferDepartment_1_2_Other);
                        parameters[58].Value = DataConv.IfNull(splitPre(model.Body.TransferDepartment_2_1));
                        parameters[59].Value = DataConv.IfNull(splitSuf(model.Body.TransferDepartment_2_1));
                        parameters[60].Value = DataConv.IfNull(splitPre(model.Body.TransferDepartment_2_2));
                        parameters[61].Value = DataConv.IfNull(splitSuf(model.Body.TransferDepartment_2_2));
                        parameters[62].Value = DataConv.IfNull(splitPre(model.Body.TransferDepartment_2_3));
                        parameters[63].Value = DataConv.IfNull(splitSuf(model.Body.TransferDepartment_2_3));
                        parameters[64].Value = DataConv.IfNull(model.Body.TransferDepartment_2_Other);
                        parameters[65].Value = DataConv.IfNull(model.Body.AptitudeDevelop_1_1);
                        parameters[66].Value = DataConv.IfNull(splitPre(model.Body.AptitudeDevelop_1_2));
                        parameters[67].Value = DataConv.IfNull(splitSuf(model.Body.AptitudeDevelop_1_2));
                        parameters[68].Value = DataConv.IfNull(model.Body.AptitudeDevelop_1_3);
                        parameters[69].Value = DataConv.IfNull(model.Body.AptitudeDevelop_2);
                        parameters[70].Value = DataConv.IfNull(model.Body.AptitudeDevelop_3);
                        parameters[71].Value = DataConv.IfNull(model.Body.FreeComment);
                        parameters[72].Value = DataConv.IfNull(model.Body.BossComment);
        ...
        public void Sign(SelfDeclareRegisterAtoCViewModels model, string value, LoginUser lu, bool isSign = true) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        /// <param name="value">ボタンのValue</param>
        public void PrevDataCopy(SelfDeclareRegisterAtoCViewModels model, LoginUser lu) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
