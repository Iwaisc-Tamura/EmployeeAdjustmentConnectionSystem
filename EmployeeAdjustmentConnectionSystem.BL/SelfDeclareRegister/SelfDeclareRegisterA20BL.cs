...
namespace EmployeeAdjustmentConnectionSystem.BL.SelfDeclareRegister {
    ...
    /// 目標管理入力ビジネスロジック
    /// </summary>
    public class SelfDeclareRegisterA20BL {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        /// デフォルトコンストラクタ
        /// </summary>
        public SelfDeclareRegisterA20BL() {
        }
                ...
                using(DbManager dm = new DbManager()) {
                    ...
                    using(DataSet ds = new DataSet()) {
                        ...
                        foreach(DataRow row in rows) {
                            ...
                            OldLifeComment1 = row["定年退職後生活設計_1"].ToString(),
            ...
            try {
                ...
                using(var scope = new TransactionScope()) {
                    using(var dm = new DbManager()) {
                        ...
                        DbHelper.AddDbParameter(cmd, "@OldLifeComment1", DbType.String);
                        ...
                        parameters[17].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_1_1_1));
                        parameters[18].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_1_1_1));
                        parameters[19].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_1_1_2));
                        parameters[20].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_1_1_2));
                        parameters[21].Value = DataConv.IfNull(model.Body.Aptitude_1_1_Other);
                        parameters[22].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_1_2_1));
                        parameters[23].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_1_2_1));
                        parameters[24].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_1_2_2));
                        parameters[25].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_1_2_2));
                        parameters[26].Value = DataConv.IfNull(model.Body.Aptitude_1_2_Other);
                        parameters[27].Value = DataConv.IfNull(model.Body.Aptitude_2_1_Duty);
                        parameters[28].Value = DataConv.IfNull(model.Body.Aptitude_2_1_License);
                        parameters[29].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_2_1_Level));
                        parameters[30].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_2_1_Level));
                        parameters[31].Value = DataConv.IfNull(model.Body.Aptitude_2_2_Duty);
                        parameters[32].Value = DataConv.IfNull(model.Body.Aptitude_2_2_License);
                        parameters[33].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_2_2_Level));
                        parameters[34].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_2_2_Level));
                        parameters[35].Value = DataConv.IfNull(model.Body.Aptitude_2_3_Duty);
                        parameters[36].Value = DataConv.IfNull(model.Body.Aptitude_2_3_License);
                        parameters[37].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_2_3_Level));
                        parameters[38].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_2_3_Level));
                        parameters[39].Value = DataConv.IfNull(model.Body.Aptitude_2_4_Duty);
                        parameters[40].Value = DataConv.IfNull(model.Body.Aptitude_2_4_License);
                        parameters[41].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_2_4_Level));
                        parameters[42].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_2_4_Level));
                        parameters[43].Value = DataConv.IfNull(model.Body.Aptitude_2_5_Duty);
                        parameters[44].Value = DataConv.IfNull(model.Body.Aptitude_2_5_License);
                        parameters[45].Value = DataConv.IfNull(splitPre(model.Body.Aptitude_2_5_Level));
                        parameters[46].Value = DataConv.IfNull(splitSuf(model.Body.Aptitude_2_5_Level));
                        parameters[47].Value = DataConv.IfNull(model.Body.Aptitude_3);
                        parameters[48].Value = DataConv.IfNull(model.Body.TransferDepartment_1);
                        parameters[49].Value = DataConv.IfNull(splitPre(model.Body.TransferDepartment_1_1));
                        parameters[50].Value = DataConv.IfNull(splitSuf(model.Body.TransferDepartment_1_1));
                        parameters[51].Value = DataConv.IfNull(model.Body.TransferDepartment_1_1_Other);
                        parameters[52].Value = DataConv.IfNull(splitPre(model.Body.TransferDepartment_1_2));
                        parameters[53].Value = DataConv.IfNull(splitSuf(model.Body.TransferDepartment_1_2));
                        parameters[54].Value = DataConv.IfNull(model.Body.TransferDepartment_1_2_Other);
                        parameters[55].Value = DataConv.IfNull(splitPre(model.Body.TransferDepartment_2_1));
                        parameters[56].Value = DataConv.IfNull(splitSuf(model.Body.TransferDepartment_2_1));
                        parameters[57].Value = DataConv.IfNull(splitPre(model.Body.TransferDepartment_2_2));
                        parameters[58].Value = DataConv.IfNull(splitSuf(model.Body.TransferDepartment_2_2));
                        parameters[59].Value = DataConv.IfNull(splitPre(model.Body.TransferDepartment_2_3));
                        parameters[60].Value = DataConv.IfNull(splitSuf(model.Body.TransferDepartment_2_3));
                        parameters[61].Value = DataConv.IfNull(model.Body.TransferDepartment_2_Other);
                        parameters[62].Value = DataConv.IfNull(model.Body.OldLifeComment1);
                        parameters[63].Value = DataConv.IfNull(model.Body.FreeComment);
                        parameters[64].Value = DataConv.IfNull(model.Body.BossComment);
