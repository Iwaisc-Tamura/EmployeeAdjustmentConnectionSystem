...
namespace EmployeeAdjustmentConnectionSystem.BL.SelfDeclareRegister {
    ...
    /// 目標管理入力ビジネスロジック
    /// </summary>
    public class SelfDeclareRegisterBBL {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        public SelfDeclareRegisterBViewModels Select(int? id) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");

                SelfDeclareRegisterBViewModels model = new SelfDeclareRegisterBViewModels();
                model.Head = new SelfDeclareRegisterBHeaderModel();
                model.Body = new SelfDeclareRegisterBBodyModel();
        ...
        public void SetMode(SelfDeclareRegisterBViewModels model, LoginUser lu) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        private void SetRootCancel(DbManager dm, SelfDeclareRegisterBViewModels model
        ...
        /// <param name="lu">ログインユーザー</param>
        /// <param name="mode">承認状態</param>
        private void SetInputSignMode(DbManager dm, SelfDeclareRegisterBViewModels model
            , LoginUser lu, SelfDeclareMode mode) {
            var sql = "select"
                    + " 管理番号"
                    + ",年度"
            ...
            using(DataSet ds = new DataSet()) {
                ...
                //モード設定
                Func<SelfDeclareRegisterBViewModels, string, SelfDeclareMode, bool> setMode = (m, u, om) => {
        ...
        public void Save(SelfDeclareRegisterBViewModels model) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        public void Sign(SelfDeclareRegisterBViewModels model, string value, LoginUser lu, bool isSign = true) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        /// <param name="value">ボタンのValue</param>
        public void PrevDataCopy(SelfDeclareRegisterBViewModels model, LoginUser lu) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
