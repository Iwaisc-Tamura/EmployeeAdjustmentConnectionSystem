...
namespace EmployeeAdjustmentConnectionSystem.BL.SelfDeclareRegister {
    ...
    /// 目標管理入力ビジネスロジック
    /// </summary>
    public class SelfDeclareRegisterA11BL {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        /// デフォルトコンストラクタ
        /// </summary>
        public SelfDeclareRegisterA11BL() {
        }
            ...
            try {
                ...
                using(var scope = new TransactionScope()) {
                    using(var dm = new DbManager()) {
                        ...
                        parameters[4].Value = DataConv.IfNull(model.Body.ChargeDuty_4);
                        parameters[5].Value = DataConv.IfNull(splitPre(model.Body.AptitudeDevelop_1_1_1));
                        parameters[6].Value = DataConv.IfNull(splitSuf(model.Body.AptitudeDevelop_1_1_1));
                        parameters[7].Value = DataConv.IfNull(splitPre(model.Body.AptitudeDevelop_1_1_2));
                        parameters[8].Value = DataConv.IfNull(splitSuf(model.Body.AptitudeDevelop_1_1_2));
                        parameters[9].Value = DataConv.IfNull(model.Body.AptitudeDevelop_1_1_Other);
                        parameters[10].Value = DataConv.IfNull(splitPre(model.Body.AptitudeDevelop_1_2_1));
                        parameters[11].Value = DataConv.IfNull(splitSuf(model.Body.AptitudeDevelop_1_2_1));
                        parameters[12].Value = DataConv.IfNull(splitPre(model.Body.AptitudeDevelop_1_2_2));
                        parameters[13].Value = DataConv.IfNull(splitSuf(model.Body.AptitudeDevelop_1_2_2));
                        parameters[14].Value = DataConv.IfNull(model.Body.AptitudeDevelop_1_2_Other);
                        parameters[15].Value = DataConv.IfNull(model.Body.AptitudeDevelop_2_Content);
                        parameters[16].Value = DataConv.IfNull(model.Body.TransferDutyDepartment_1_Content);
                        parameters[17].Value = DataConv.IfNull(splitPre(model.Body.TransferDutyDepartment_1_1));
                        parameters[18].Value = DataConv.IfNull(splitSuf(model.Body.TransferDutyDepartment_1_1));
                        parameters[19].Value = DataConv.IfNull(model.Body.TransferDutyDepartment_1_1_Other);
                        parameters[20].Value = DataConv.IfNull(splitPre(model.Body.TransferDutyDepartment_1_2));
                        parameters[21].Value = DataConv.IfNull(splitSuf(model.Body.TransferDutyDepartment_1_2));
                        parameters[22].Value = DataConv.IfNull(model.Body.TransferDutyDepartment_1_2_Other);
                        parameters[23].Value = DataConv.IfNull(splitPre(model.Body.TransferDutyDepartment_2_1));
                        parameters[24].Value = DataConv.IfNull(splitSuf(model.Body.TransferDutyDepartment_2_1));
                        parameters[25].Value = DataConv.IfNull(splitPre(model.Body.TransferDutyDepartment_2_2));
                        parameters[26].Value = DataConv.IfNull(splitSuf(model.Body.TransferDutyDepartment_2_2));
                        parameters[27].Value = DataConv.IfNull(splitPre(model.Body.TransferDutyDepartment_2_3));
                        parameters[28].Value = DataConv.IfNull(splitSuf(model.Body.TransferDutyDepartment_2_3));
                        parameters[29].Value = DataConv.IfNull(model.Body.TransferDutyDepartment_2_Other);
                        parameters[30].Value = DataConv.IfNull(model.Body.FreeComment);
                        parameters[31].Value = DataConv.IfNull(model.Body.BossComment);
