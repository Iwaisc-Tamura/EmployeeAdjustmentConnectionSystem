...
namespace EmployeeAdjustmentConnectionSystem.BL.SelfDeclareRegister {
    ...
    /// 目標管理入力ビジネスロジック
    /// </summary>
    public class SelfDeclareRegisterABL {
        #region メンバ変数
        /// <summary>
        /// ロガー
        /// </summary>
        ...
        public SelfDeclareRegisterAViewModels Select(int? id) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");

                SelfDeclareRegisterAViewModels model = new SelfDeclareRegisterAViewModels();
                model.Head = new SelfDeclareRegisterAHeaderModel();
                model.Body = new SelfDeclareRegisterABodyModel();
        ...
        public void SetMode(SelfDeclareRegisterAViewModels model, LoginUser lu) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        private void SetRootCancel(DbManager dm, SelfDeclareRegisterAViewModels model
        ...
        /// <param name="lu">ログインユーザー</param>
        /// <param name="mode">承認状態</param>
        private void SetInputSignMode(DbManager dm, SelfDeclareRegisterAViewModels model
            , LoginUser lu, SelfDeclareMode mode) {
            var sql = "select"
                    + " 管理番号"
                    + ",年度"
            ...
            using(DataSet ds = new DataSet()) {
                ...
                //モード設定
                Func<SelfDeclareRegisterAViewModels, string, SelfDeclareMode, bool> setMode = (m, u, om) => {
        ...
        public void Save(SelfDeclareRegisterAViewModels model) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        public void Sign(SelfDeclareRegisterAViewModels model, string value, LoginUser lu, bool isSign = true) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
        ...
        /// <param name="value">ボタンのValue</param>
        public void PrevDataCopy(SelfDeclareRegisterAViewModels model, LoginUser lu) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
