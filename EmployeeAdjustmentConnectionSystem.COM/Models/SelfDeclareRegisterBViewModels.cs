...
namespace EmployeeAdjustmentConnectionSystem.COM.Models {
    ...
    /// 目標管理入力モデル
    /// </summary>
    public class SelfDeclareRegisterBViewModels {
        /// <summary>
        /// ヘッダ部
        /// </summary>
        public SelfDeclareRegisterBHeaderModel Head { get; set; }

        /// <summary>
        /// ボディ部
        /// </summary>
        public SelfDeclareRegisterBBodyModel Body { get; set; }
    ...
    /// ヘッダ
    /// </summary>
    public class SelfDeclareRegisterBHeaderModel {
        /// <summary>
        /// クラスの新しいインスタンスを初期化します。
        /// </summary>
        public SelfDeclareRegisterBHeaderModel() {
    ...
    /// ボディ
    /// </summary>
    public class SelfDeclareRegisterBBodyModel {
