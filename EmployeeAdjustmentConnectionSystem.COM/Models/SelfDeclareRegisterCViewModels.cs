...
namespace EmployeeAdjustmentConnectionSystem.COM.Models {
    ...
    /// 目標管理入力モデル
    /// </summary>
    public class SelfDeclareRegisterCViewModels {
        /// <summary>
        /// ヘッダ部
        /// </summary>
        public SelfDeclareRegisterCHeaderModel Head { get; set; }

        /// <summary>
        /// ボディ部
        /// </summary>
        public SelfDeclareRegisterCBodyModel Body { get; set; }
    ...
    /// ヘッダ
    /// </summary>
    public class SelfDeclareRegisterCHeaderModel {
        /// <summary>
        /// クラスの新しいインスタンスを初期化します。
        /// </summary>
        public SelfDeclareRegisterCHeaderModel() {
    ...
    /// ボディ
    /// </summary>
    public class SelfDeclareRegisterCBodyModel {
